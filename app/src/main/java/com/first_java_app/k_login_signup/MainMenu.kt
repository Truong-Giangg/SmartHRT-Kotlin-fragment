...
//                            userGet[userNum].btnID,
//                            userGet[userNum].getbtnName(),
//                            userGet[userNum].getbtnValue()
//                        )
//                    }
...
//                        reference!!.child(userGet[i].btnID).setValue(userGet[i])
//                        Toast.makeText(
//                            this@MainMenu,
//                            "đã bật " + userGet[i].getbtnName(),
//                            Toast.LENGTH_LONG
//                        ).show()
//                    } else if (a.contentEquals("Tắt " + userGet[i].getbtnName()) || a.contentEquals(
//                            "tắt " + userGet[i].getbtnName()
//                        )
//                    ) {
...
//
//    companion object {
//        var addedWidgetSW: Array<Switch?>
//        var addedWidgetSB: Array<SeekBar?>
//        var addedWidgetTX: Array<TextView?>
//    }
//}